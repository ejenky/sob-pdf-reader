...
const SOBParser = {
  ...
  FIELD_DEFS: [
    ...
    },
    {
      key: 'urgentCopay',
      label: 'Urgent Care',
      patterns: [/urgent\s*care/i, /urgently\s*needed/i, /emergency\s*and\s*urgent/i],
      // No antiPatterns for emergency — urgent care is often in the same row
      source: 'inNetwork',
      normalize: 'urgentSpecial', // Special: extract urgent from combined cell
      priority: 2
    },
    {
      key: 'hospitalCopay',
    ...
    },
    {
      ...
      antiPatterns: [/ambulance/i, /fixed\s*wing/i],
      source: 'inNetwork',
